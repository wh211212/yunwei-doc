#!/bin/bash
###############################
# Zabbix log monitoring for Haporxy
###############################
# Contact :
...
STAT_FILE=$CURRENT_DIR/../tmp/haproxy-log.stat
...
SCRIPT_CONF=$CURRENT_DIR/../conf/nc_haproxy-log_check.conf
