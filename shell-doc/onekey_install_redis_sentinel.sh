...
echo "slaveof $redis_sentinel_ip 9000" >> $redis_sentinel_dir/9002/redis.conf
...
echo 'logfile "/var/log/redis/sentinel_9000.log"' >> $redis_sentinel_dir/9000/sentinel.conf
#
