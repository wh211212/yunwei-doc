#!/bin/bash
###############################################################
# functions: backup zabbix important tables
# crontab -e (0 3 * * * ${PATH}/zabbix_mysqldump_per_table.sh)
###############################################################
#contact:
#    -- wh211212@qq.com
###############################################################
...
#  2017-03-21    wh    change zabbix database 
##############################################################
...
################################################################
#my.cnf=/opt/zabbix/etc/.my.cnf
MySQL_HOST=127.0.0.1
MySQL_USER=zabbix
MySQL_PASSWORD=@Aniuzabbix123.
MySQL_PORT=3306
MySQL_DUMP_PATH=/home/wh/backup/mysql_backup
